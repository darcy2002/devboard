...
const Sidebar = () => {
  return (
    <aside className="hidden lg:flex lg:flex-col w-56 border-r border-gray-200 bg-gray-50 min-h-[calc(100vh-3.5rem)]">
      ...
      <div className="px-4 py-3 border-t border-gray-200">
        <p className="text-xs text-gray-400">DevBoard v1.0.0</p>
      </div>
    </aside>
  );
};
